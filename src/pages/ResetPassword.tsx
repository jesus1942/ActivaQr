  ...
  if (!token) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#FAFAF7] p-4">
        <div className="w-full max-w-md bg-white border-2 border-slate-900 shadow-[6px_6px_0px_0px_#1e293b] p-8 text-center">
          <p className="font-black text-lg uppercase text-slate-900">Link invalido</p>
        ...
        <div className="bg-white border-2 border-slate-900 shadow-[6px_6px_0px_0px_#1e293b] p-8">
          ...
          {exito ? (
            <div className="space-y-4 text-center">
              <div className="bg-green-50 border-2 border-green-300 text-green-700 text-sm px-3 py-3 font-semibold">
                Contrasena actualizada. Podes iniciar sesion.
              </div>
              <a
                href="#/"
                className="inline-block mt-2 text-xs text-slate-500 underline hover:text-orange-500 transition-colors"
              >
