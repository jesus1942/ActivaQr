...
<main>
  <div class="wrap">
    ...
    <p>ActivaQR utiliza almacenamiento de sesi&oacute;n del navegador (<code>sessionStorage</code>) para conservar el token JWT mientras dure la sesi&oacute;n y almacenamiento local (<code>localStorage</code>) para guardar preferencias del Cliente y cachear datos operativos. Estos datos no se comparten con terceros.</p>
    <p>En el sitio p&uacute;blico (landing y registro) utilizamos <strong>Google Ads</strong> para medir la efectividad de nuestras campa&ntilde;as publicitarias. Esta herramienta instala cookies de terceros que permiten a Google reconocer al visitante y atribuir el registro a un anuncio. Los datos que recibe Google se rigen por sus propias pol&iacute;ticas (<a href="https://policies.google.com/privacy" target="_blank" rel="noopener">policies.google.com/privacy</a>). Pod&eacute;s bloquear estas cookies desde la configuraci&oacute;n de tu navegador o mediante la <a href="https://tools.google.com/dlpage/gaoptout" target="_blank" rel="noopener">extensi&oacute;n de inhabilitaci&oacute;n de Google</a>, sin que eso afecte el funcionamiento de la aplicaci&oacute;n.</p>
    <p><strong>Dentro de la aplicaci&oacute;n</strong> —una vez iniciada la sesi&oacute;n— no se ejecuta publicidad ni seguimiento de terceros: los datos operativos del Cliente (activos, mediciones, mantenimientos) nunca se comparten con redes publicitarias.</p>
