...
export const ENTRADAS_BITACORA: EntradaBitacora[] = [
  {
    ...
    fechaIso: '2026-09-08',
    titulo: 'Las luces identificadas ahora se operan con un solo toque',
    resumen: 'ActivaQR Control distingue las cargas de iluminación de las maniobras críticas. Cuando un canal está identificado como luz, el comando se envía directamente y el tablero muestra de inmediato que la orden está en curso.',
    impacto: 'La operación cotidiana se vuelve tan rápida como una app de domótica sin perder las protecciones de ActivaQR: motores, bombas, compresores y equipos críticos siguen requiriendo confirmación antes de actuar.',
    capacidades: ['Encendido y apagado de luces con un toque', 'Bloqueo de órdenes duplicadas mientras se actualiza el estado', 'Confirmación conservada para cargas críticas'],
    destacada: true,
  },
  {
    version: 'RGBW TUYA',
    fecha: '8 de septiembre de 2026',
    fechaIso: '2026-09-08',
    titulo: 'ActivaQR incorpora control RGBW para iluminación Tuya / Smart Life',
    resumen: 'Los dispositivos de iluminación compatibles con Tuya pueden exponer controles específicos de encendido, brillo, temperatura de color y color RGBW dentro del mismo tablero industrial.',
    impacto: 'Las luces dejan de aparecer como simples interruptores genéricos. ActivaQR puede interpretar sus capacidades reales y ofrecer una experiencia de control acorde al dispositivo.',
    capacidades: ['Controles RGBW según capacidades del dispositivo', 'Validación de comandos antes de enviarlos a Tuya', 'Registro y auditoría de las maniobras realizadas'],
    destacada: true,
  },
  {
    version: 'ALERTAS',
    ...
    fechaIso: '2026-08-27',
    titulo: 'El historial crece y las alertas pueden llegar por Telegram',
    resumen: 'ActivaQR amplió el historial de telemetría y sumó alertas de Control Industrial por Telegram, incluyendo la detección de aumentos bruscos de temperatura además de los umbrales configurados.',
    impacto: 'Una anomalía ya no depende de que alguien esté mirando el tablero en ese momento. El sistema puede conservar más contexto y avisar cuando una variable cambia de manera preocupante.',
    capacidades: ['Historial ampliado de variables IoT', 'Alertas por Telegram con consentimiento', 'Detección de aumentos bruscos de temperatura'],
    destacada: true,
  },
  {
    version: 'CONTROL UNIFICADO',
    fecha: '26 de agosto de 2026',
    fechaIso: '2026-08-26',
    titulo: 'Activa Control y el tablero IoT pasan a ser una sola experiencia',
    resumen: 'La sección Activa Control se unificó con el tablero IoT para evitar pantallas duplicadas y concentrar dispositivos, telemetría, alarmas, escenas y configuración en el mismo flujo de trabajo.',
    impacto: 'El operador entra a un único lugar para entender qué está pasando y actuar. Menos navegación significa menos tiempo buscando controles y menor riesgo de operar desde una vista equivocada.',
    capacidades: ['Vista unificada de dispositivos y variables', 'Escenas, alertas y configuración en el mismo tablero', 'Experiencia coherente en escritorio y móvil'],
    destacada: true,
  },
  {
    version: 'TABLERO IOT',
    ...
    fechaIso: '2026-08-25',
    titulo: 'El tablero IoT adopta una operación más clara y automatizaciones seguras',
    resumen: 'El panel de Control Industrial fue reorganizado para priorizar el estado útil de cada dispositivo, las acciones principales y las automatizaciones sin exponer complejidad técnica innecesaria.',
    impacto: 'ActivaQR empieza a comportarse como una consola operativa y no como una colección de datos: lo importante aparece primero y las acciones sensibles mantienen controles explícitos.',
    capacidades: ['Cards orientadas a operación', 'Automatizaciones y escenas seguras', 'Telemetría técnica disponible sin dominar la interfaz'],
    destacada: true,
  },
  {
    version: 'ENERGÍA',
